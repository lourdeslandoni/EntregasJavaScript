...
function imgAlert()
{
    const btn = document.getElementById("botonFormula");
    btn.addEventListener("click", ()=>{

        Swal.fire({
            title:'UPS!',
            text:'Botón en construcción :( Estará listo para próximas entregas',
            icon: 'warning',
            showConfirmButton: false,
            imageWidth: "70%",
            imageUrl: 'https://www.crushpixel.com/big-static15/preview4/3d-illustration-website-under-construction-2047402.jpg'
        })
    })
}
